!function (t, e) {
    ...
    var N = "SweetAlert2:", U = function (t) {
    ...
    var dt, pt = function (t, e) {
            ...
            for (var n = 0; n < t.childNodes.length; n++) if (H(t.childNodes[n], e)) return t.childNodes[n]
        }, ht = function (t) {
    ...
    var Be = function (t, e) {
        ...
        }, He = ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"], De = ["Escape", "Esc"],
        Ne = function (t, e, n) {
    ...
    var Ge, tn = function (t) {
        ...
        hideLoading: ee, disableLoading: ee, getInput: function (t) {
            var e = Pt.innerParams.get(t || this), n = Pt.domCache.get(t || this);
            return n ? J(n.content, e.input) : null
        }, close: ue, closePopup: ue, closeModal: ue, closeToast: ue, enableButtons: function () {
            ...
            var e = function (t) {
                var e = s({}, $t.showClass, t.showClass), n = s({}, $t.hideClass, t.hideClass), o = s({}, $t, t);
